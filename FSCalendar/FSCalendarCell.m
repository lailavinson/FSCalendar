...
- (void)layoutSubviews
{
    ...
    if (_subtitle) {
        ...
        _subtitleLabel.frame = CGRectMake(
                                          ...
                                          (_titleLabel.fs_bottom-self.preferredTitleOffset.y-10) - (_titleLabel.fs_height-_titleLabel.font.pointSize)+self.preferredSubtitleOffset.y,
                                          self.contentView.fs_width,
                                          subtitleHeight
                                          );
    } else {
...
- (void)configureAppearance
{
    ...
    UIFont *titleFont = self.calendar.scope == FSCalendarScopeWeek ? self.calendar.appearance.titleFontWeek : self.calendar.appearance.titleFont;
